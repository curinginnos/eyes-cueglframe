...
namespace ArgusSamples
{
                                                            ...
                                                            float *time)
    {
        ...
        // uchar *d_CrCb_middle = &d_CrCb[(WIDTH * HEIGHT / 8)];
        ...
        // dim3 threadsPerBlock(WIDTH/2, HEIGHT/2);
        // // unravel<<<1, threadsPerBlock>>>(d_arr, d_arr_odd, d_arr_even);

        // unravel<<<1,threadsPerBlock>>>(d_CrCb, d_Cr, d_Cb, WIDTH / 2, WIDTH * HEIGHT / 8);
        ...
        // -14
        // NppStatus npperr = nppiNV12ToBGR_8u_P2C3R(pSrc, WIDTH * sizeof(uchar), d_bgr, WIDTH * sizeof(uchar), roi);

        // -14
        // NppStatus npperr = nppiNV12ToBGR_8u_P2C3R(pSrc,
        //                                           static_cast<int>(WIDTH * sizeof(uchar)),
        //                                           d_bgr,
        //                                           static_cast<int>(WIDTH * sizeof(uchar)),
        //                                           roi);
        ...
        // OMG (IT'S THREE CHANNEL....)
        // NppStatus npperr = nppiNV12ToRGB_709HDTV_8u_P2C3R(pSrc,
        //                                           static_cast<int>(WIDTH),
        //                                           d_bgr,
        ...
        // Not working
        // uchar *h_bgr = (uchar *)malloc(ARRAY_BYTES * 3);
        // err = cudaMemcpy(h_bgr, d_bgr, ARRAY_BYTES *3, cudaMemcpyDeviceToHost);
        // checkError(err, "cudaMemcpy");
        ...
        dumpArrayFile(h_CrCb, WIDTH * HEIGHT, "CrCb", FILE_IDX);
        ...
        // gpuMat.create(HEIGHT, WIDTH, CV_8UC3);
        // gpuMat.data = d_bgr;
        ...
        // NppStatus npperr = nppiNV21ToBGR_8u_P2C4R(pSrc, WIDTH, d_bgr, WIDTH, roi);
